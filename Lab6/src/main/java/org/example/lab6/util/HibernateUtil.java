package org.example.democud.util;
...
public class HibernateUtil {
    ...
    static {
        ...
        properties.put(Environment.URL, "jdbc:sqlserver://localhost:1433;databaseName=SOF3012_PracticeDB;encrypt=true;trustServerCertificate=true");
