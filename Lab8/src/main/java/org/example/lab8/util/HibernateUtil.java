...
public class HibernateUtil {
    ...
    static {
        ...
        properties.put(Environment.URL, "jdbc:sqlserver://localhost:1433;databaseName=TravelWishlistDB;encrypt=true;trustServerCertificate=true");
